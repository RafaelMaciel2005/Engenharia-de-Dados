...
def main():
    ...
    spark = create_spark_session("Landing-to-Bronze-reviews")
    
    input_path = "s3a://landing-zone/vendas/*/olist_order_reviews_dataset.csv"
    output_path = "s3a://bronze/olist/reviews/"
