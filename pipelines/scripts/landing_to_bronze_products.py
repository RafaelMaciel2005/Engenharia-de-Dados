...
def main():
    ...
    spark = create_spark_session("Landing-to-Bronze-products")
    
    input_path = "s3a://landing-zone/vendas/*/olist_products_dataset.csv"
    output_path = "s3a://bronze/olist/products/"
