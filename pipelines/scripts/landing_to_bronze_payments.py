...
def main():
    ...
    spark = create_spark_session("Landing-to-Bronze-Payments")
    
    input_path = "s3a://landing-zone/vendas/*/olist_order_payments_dataset.csv"
    output_path = "s3a://bronze/olist/payments/"
