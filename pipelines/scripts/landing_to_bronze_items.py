...
def main():
    ...
    spark = create_spark_session("Landing-to-Bronze-items")
    
    input_path = "s3a://landing-zone/vendas/*/olist_order_items_dataset.csv"
    output_path = "s3a://bronze/olist/items/"

    print(f"Lendo os dados brutos de: {input_path}")
